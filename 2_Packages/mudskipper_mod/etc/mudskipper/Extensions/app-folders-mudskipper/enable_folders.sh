...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Web/ apps "['Cutegram.desktop','firefox.desktop','opera.desktop','thunderbird.desktop']"
